...
select a.filename, a.PatientID, a.studydttm, a.ga, a.episode_working_edd, a.mom_birth_date, a.mom_age_edd, a.DOC,
a.mom_weight_oz, a.mom_height_in, coalesce(a.smoking_tob_use_c, b.smoking_tob_use_c) as tobacco_use, 
a.tobacco_pak_per_dy as tobacco_pak_per_day, datepart(a.studydttm) - a.smoking_quit_date as smoking_quit_days
from
